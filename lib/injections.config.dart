...
import 'application/activity/bloc/activity_bloc.dart' as _i45;
...
import 'domain/activity/i_activity_facade.dart' as _i6;
import 'domain/activity/use_cases/get_activity_data_use_case.dart' as _i36;
import 'domain/activity/use_cases/save_activity_data_use_case.dart' as _i30;
...
import 'domain/menstrual/use_cases/save_menstrual_data_use_case.dart' as _i31;
...
import 'infrastructure/activity/activity_facade.dart' as _i7;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i6.IActivityFacade>(() => _i7.ActivityFacade());
  ...
  gh.lazySingleton<_i29.PedestrianStatusUseCase>(
      () => _i29.PedestrianStatusUseCase(get<_i18.IPedometerFacade>()));
  gh.lazySingleton<_i30.SaveActivityDataUseCase>(
      () => _i30.SaveActivityDataUseCase(get<_i6.IActivityFacade>()));
  gh.lazySingleton<_i31.SaveMenstrualDataUseCase>(
      () => _i31.SaveMenstrualDataUseCase(get<_i14.IMenstrualFacade>()));
  gh.lazySingleton<_i32.SettingUserNameUseCase>(
      () => _i32.SettingUserNameUseCase(get<_i20.ISettingsFacade>()));
  ...
  gh.factory<_i34.AtContactInitializationUseCase>(
      () => _i34.AtContactInitializationUseCase(get<_i10.IContactsFacade>()));
  gh.factory<_i35.GetActiveAtsignUseCase>(
      () => _i35.GetActiveAtsignUseCase(get<_i10.IContactsFacade>()));
  gh.lazySingleton<_i36.GetActivityDataUseCase>(
      () => _i36.GetActivityDataUseCase(get<_i6.IActivityFacade>()));
  ...
  gh.factory<_i39.GetOnBoardedAtSignUseCase>(
      () => _i39.GetOnBoardedAtSignUseCase(get<_i8.IAtsignOnBoardingFacade>()));
  ...
  gh.lazySingleton<_i41.MenstrualBloc>(() => _i41.MenstrualBloc(
      get<_i31.SaveMenstrualDataUseCase>(),
  ...
  gh.lazySingleton<_i45.ActivityBloc>(() => _i45.ActivityBloc(
      get<_i30.SaveActivityDataUseCase>(), get<_i36.GetActivityDataUseCase>()));
  return get;
}
